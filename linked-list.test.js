...
describe("pivot around value", function() {

  it("correctly pivots around a given value", function(){
    let lst = new LinkedList([7, 6, 2, 3, 9, 1, 1]);
    lst.pivot(5);
    expect(lst.toArr()).toStrictEqual([2, 3, 1, 1, 7, 6, 9]);
  })

  it("correctly pivots around a given value (2)", function(){
    let lst = new LinkedList([7, 6, 2, 5, 3, 5, 9, 1, 1]);
    lst.pivot(5);
    expect(lst.toArr()).toStrictEqual([2, 3, 1, 1, 7, 6, 5, 5, 9])
  })
